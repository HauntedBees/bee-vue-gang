...
import { VTooltip, VBtn, VProgressCircular } from 'vuetify/lib';
...
var LoadableButton = /** @class */ (function (_super) {
    ...
    LoadableButton = __decorate([
        Component({ components: { VBtn: VBtn, VProgressCircular: VProgressCircular } })
    ], LoadableButton);
...
var Loader = /** @class */ (function (_super) {
    ...
    Loader = __decorate([
        Component({ components: { VProgressCircular: VProgressCircular } })
    ], Loader);
    return Loader;
}(Vue));
