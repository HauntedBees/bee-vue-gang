...
var Attribution = /** @class */ (function (_super) {
    ...
    Attribution = __decorate([
        vuePropertyDecorator.Component({ components: { ExternalLink: __vue_component__ } })
    ], Attribution);
    return Attribution;
}(vuePropertyDecorator.Vue));
...
var SpanTooltip = /** @class */ (function (_super) {
    ...
    SpanTooltip = __decorate([
        vuePropertyDecorator.Component({ components: { VTooltip: lib.VTooltip } })
    ], SpanTooltip);
    return SpanTooltip;
}(vuePropertyDecorator.Vue));
...
var LoadableButton = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: "mr-4" })
    ], LoadableButton.prototype, "css", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: false })
    ], LoadableButton.prototype, "dark", void 0);
    __decorate([
        vuePropertyDecorator.Prop()
    ], LoadableButton.prototype, "color", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: "Save" })
    ], LoadableButton.prototype, "text", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: "Saving" })
    ], LoadableButton.prototype, "loadtext", void 0);
    LoadableButton = __decorate([
        vuePropertyDecorator.Component({ components: { VBtn: lib.VBtn, VProgressCircular: lib.VProgressCircular } })
    ], LoadableButton);
...
var __vue_render__$4 = function() {
  ...
  return _c(
    "VBtn",
    {
      class: "bee-loadable-button " + _vm.css,
      attrs: {
        color: _vm.color,
        dark: _vm.dark,
...
var Loader = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: 48 })
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: false })
    ], Loader.prototype, "dark", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: "primary" })
    ], Loader.prototype, "color", void 0);
    Loader = __decorate([
        vuePropertyDecorator.Component({ components: { VProgressCircular: lib.VProgressCircular } })
    ], Loader);
    return Loader;
}(vuePropertyDecorator.Vue));
...
exports.Attribution = __vue_component__$1;
exports.ClassDirective = ClassDirective;
exports.Emoji = __vue_component__$2;
exports.ExternalLink = __vue_component__;
exports.LoadableButton = __vue_component__$4;
exports.Loader = __vue_component__$5;
exports.SpanTooltip = __vue_component__$3;
